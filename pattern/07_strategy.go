...
Применение:
    ...
    Когда у вас есть множество похожих структур, отличающихся только некоторым поведением.
    Когда вы не хотите обнажать детали реализации алгоритмов для других структур.

Плюсы:
    Замена алгоритмов на лету.
    Изолирует код и данные алгоритмов от остальных структур.
